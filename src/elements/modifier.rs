...
bitflags! {
    ...
    pub struct ElementModifier: u16 {
        ...
        const RETURN =          0b0000_0000_0010_0000;

        /// Control flow signal to immediately stop execution.
        const TERMINATE =       0b0000_0000_0100_0000;
        
        /// Not nullable variable value flag.
        const NOT_NULLABLE =    0b0000_0000_1000_0000;
        
        /// Dereferenced value's reference flag.
        const DEREFERENCED =    0b0000_0001_0000_0000;
    }
}